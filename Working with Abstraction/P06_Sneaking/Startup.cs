...
namespace Sneaking
{
    public class Startup
    {
        ...
        public static void Main()
        {
            ...
            PlayerPosition(out moves, out samPosition);

            PositionCheck(moves, samPosition);
        }

        private static void PositionCheck(char[] moves, int[] samPosition)
        {
        ...
        private static void PlayerPosition(out char[] moves, out int[] samPosition)
        {
        ...
        private static void MatrixRead()
        {
